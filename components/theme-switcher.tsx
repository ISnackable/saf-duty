...
export const ThemeSwitcher = () => {
	...
	return (
		<div className="flex h-9 rounded-full border-[1px] border-solid border-[#eaeaea] dark:border-[#333] bg-[#fafafa] dark:bg-[#111] p-[3px] w-fit">
			<span style={{ height: "100%" }}>
				...
				<label
					className={
						...
						" " +
						"[&_svg]:relative [&_svg]:z-[1] [&_svg]:h-4 [&_svg]:w-4 dark:[&_svg]:!text-[#888] [&_svg]:!text-[#666666] [&_svg]:transition-colors [&_svg]:duration-100 [&_svg]:ease-in-out" +
						" " +
						"hover:[&_svg]:!text-[#111111] dark:hover:[&_svg]:!text-[#fafafa] peer-checked/system:[&_svg]:!text-[#111111] dark:peer-checked/system:[&_svg]:!text-[#fafafa]"
					}
			...
			<span style={{ height: "100%" }}>
				...
				<label
					className={
						...
						"[&_svg]:relative [&_svg]:z-[1] [&_svg]:h-4 [&_svg]:w-4 dark:[&_svg]:!text-[#888] [&_svg]:!text-[#666666] [&_svg]:transition-colors [&_svg]:duration-100 [&_svg]:ease-in-out" +
						" " +
						"hover:[&_svg]:!text-[#111111] dark:hover:[&_svg]:!text-[#fafafa] peer-checked/dark:[&_svg]:!text-[#111111] dark:peer-checked/dark:[&_svg]:!text-[#fafafa]"
					}
			...
			<span style={{ height: "100%" }}>
				...
				<label
					className={
						...
						"[&_svg]:relative [&_svg]:z-[1] [&_svg]:h-4 [&_svg]:w-4 dark:[&_svg]:!text-[#888] [&_svg]:!text-[#666666] [&_svg]:transition-colors [&_svg]:duration-100 [&_svg]:ease-in-out" +
						" " +
						"hover:[&_svg]:!text-[#111111] dark:hover:[&_svg]:!text-[#fafafa] peer-checked/light:[&_svg]:!text-[#111111] dark:peer-checked/light:[&_svg]:!text-[#fafafa]"
					}
