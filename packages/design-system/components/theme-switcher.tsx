...
export function ThemeSwitcher() {
  ...
  return (
    <div className="flex h-9 w-fit rounded-full border-[#eaeaea] border-[1px] border-solid bg-[#fafafa] p-[3px] dark:border-[#333] dark:bg-[#111]">
      <span style={{ height: '100%' }}>
        ...
        <label
          className={
            ...
            ' ' +
            '[&_svg]:!text-[#666666] dark:[&_svg]:!text-[#888] [&_svg]:relative [&_svg]:z-[1] [&_svg]:h-4 [&_svg]:w-4 [&_svg]:transition-colors [&_svg]:duration-100 [&_svg]:ease-in-out' +
            ' ' +
