...
const AvatarBadge = ({
  ...
  return (
    <div
      className={cn(
        'absolute right-0 bottom-0 box-border flex h-4 w-4 translate-x-[2px] translate-y-[2px] select-none items-center justify-center rounded-full border-2 border-background font-bold text-white text-xs',
        placementClass,
        `bg-green-500`,
        className
      )}
