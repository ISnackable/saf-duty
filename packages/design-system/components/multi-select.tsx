    ...
    return (
      ...
      >
        ...
        <div className="relative mt-2">
          {open && (
            <CommandList className="scrollbar-thin scrollbar-track-transparent scrollbar-thumb-muted-foreground dark:scrollbar-thumb-muted scrollbar-thumb-rounded-lg absolute top-0 z-10 w-full animate-in rounded-md border bg-popover text-popover-foreground shadow-md outline-none transition-colors">
              {isLoading ? (
                <>{loadingIndicator}</>
              ) : (
                <>
