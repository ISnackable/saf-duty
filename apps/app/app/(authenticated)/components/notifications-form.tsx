...
import { InstallPWA } from '@repo/design-system/components/install-pwa';
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <InstallPWA open={open} onOpenChange={setOpen}>
            <Checkbox
              ...
              onCheckedChange={async (checkedState) => {
                ...
                //   (!isPWAInstalled || !pushNotificationSupported)
                // ) {
                //   setOpen((prev) => !prev);
                //   return;
                // }
        ...
        <div>
          <h3 className="mb-4 font-medium text-lg">Notifications Options</h3>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  ...
                  <FormControl>
                    <Switch
                      //   disabled={userSubscription ? false : true}
                      checked={field.value}
