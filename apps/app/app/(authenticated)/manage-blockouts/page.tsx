...
export default function ManageBlockoutsPage() {
  return (
    <div className="space-y-4 p-8 pt-4">
      <div data-tour="manage-blockouts-page">
        <div className="flex w-full items-center space-y-2">
          <Icons.edit className="mr-3 inline-block h-8 w-8 items-center align-middle" />
          <h1
            data-tour="test-2"
            className="grow scroll-m-20 border-b pb-2 font-extrabold text-2xl tracking-tight sm:text-4xl lg:text-5xl"
          >
            Manage Blockouts
          </h1>
        </div>
