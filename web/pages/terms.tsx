...
import { Anchor, Container, Title, Text, List, Box } from "@mantine/core";
      ...
      <section>
        <Container size="sm" my="xl">
          ...
          <List withPadding>
            ...
            <List.Item>
              You agree not to circumvent or attempt to circumvent any
              filtering, security measures, rate limits or other features
              designed to protect the Service, users of the Service, or third
              parties.
            </List.Item>
          </List>
          ...
          <Text size="md" my="md">
            I may update this Terms as needed to comply with relevant
            regulations and reflect any new practices at any time.
          </Text>
        </Container>
      </section>
    </>
