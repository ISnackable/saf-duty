    ...
    <>
      <section>
        <Container size='sm' my='xl'>
          ...
          <List withPadding>
            <List.Item>
              Personal information like name and email is collected
            </List.Item>
            <List.Item>
              Only neccessary cookies is stored in the browser, like
          ...
          <Text size='md' my='md'>
            To use this application, users have to register an account,
            providing details such as their name and email address. This
            information is used to identify the user and to provide a
            personalized experience as well as to be used to generate a duty
            roster.
          </Text>
          ...
          <Text size='md' my='md'>
            ...
            version you are using. However, I <strong>do not</strong> track and
          ...
          <List>
            <List.Item>
              <strong>For duty roster generation purposes.</strong> It is only
              used to view generate a duty roster, in such that the only
              information I would access is your name.
            </List.Item>
          </List>
          ...
          <Text size='md' my='md'>
            ...
            <Anchor href='https://en.wikipedia.org/wiki/Transport_Layer_Security'>
              SSL/TLS
            </Anchor>{' '}
          ...
          <Anchor href='https://www.sanity.io/'>sanity.io</Anchor> and is
          encrypted using <Anchor href='https://argon2.online/'>argon2</Anchor>{' '}
          hashing algorithm.
