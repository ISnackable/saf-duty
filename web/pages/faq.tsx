          ...
          <Col span={12} md={6}>
            ...
            >
              <Accordion.Item className={classes.item} value='reset-password'>
                ...
                <Accordion.Panel>
                  For now, you have to contact the admin to reset your password.
                  However, you can change your password if you are logged in at
                  the{' '}
              ...
              <Accordion.Item className={classes.item} value='report-bugs'>
                ...
                <Accordion.Panel>
                  ...
                  <Anchor href='https://github.com/ISnackable/'>
                    @ISnackable
                  </Anchor>
                  .
                </Accordion.Panel>
